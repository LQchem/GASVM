...
def GA_SVM(generator, SVM, dataset,inp_dim):
...
#	real_targets = torch.FloatTensor([1])
	...
	for epoch in range(Epoch):
		...
		#=============
		#attempt1
		g_loss = generator.loss1(gen_data, threshold)  #generator.info.loss_func(accum_dist, threshold)	

		random.shuffle(dataset)
		#attempt2
		#g_loss = generator.loss2(gen_data,dataset[0])
		#================
		g_loss.backward()
...
#			p.data.clamp_(-c_value,c_value)
		...
		for idx,batch_tensor in enumerate(dataset): 
			#train SVM
